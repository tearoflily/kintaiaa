...
ActiveRecord::Schema.define(version: 20200723142042) do
  ...
  create_table "attendances", force: :cascade do |t|
    ...
    t.integer "request_type_before_copy"
    t.integer "request_status_before_copy"
    t.datetime "request_at_before_copy"
